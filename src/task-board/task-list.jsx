...
export default function TaskList({tasks, onUpdate, onTaskDelete, onFav}){
    return(
                        ...
                        <tr key={task.id} className="border-b border-[#2E3443] [&>td]:align-baseline [&>td]:px-4 [&>td]:py-2">
                            ...
                            <td>
                                <div className="flex items-center justify-center space-x-3">
                                    <button className="text-red-500" onClick={() => onTaskDelete( task.id )}>Delete</button>
                                    <button className="text-blue-500" onClick={() => onUpdate( task )}>Edit</button>
                                </div>
                            </td>
                        </tr>
                    ) )}
